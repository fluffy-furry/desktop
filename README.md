> **Fork notice:** This is a direct fork of [desktop/desktop](https://github.com/desktop/desktop). Linux support and the README below come from [Brendan Forster (@shiftkey)](https://github.com/shiftkey/desktop) and its contributors; see [credits](CREDITS.md). Download this fork's CI-built x64 and ARM64 `.deb`, `.rpm`, `.AppImage`, and Arch `.pkg.tar.zst` packages from [our releases](https://github.com/fluffy-furry/desktop/releases). The ARM64 Arch package targets Arch Linux ARM. The original README follows unchanged; its badge, AUR link, package feeds, and release links point to Shiftkey/community builds. See [our Linux build guide](docs/contributing/linux-builds.md) for installation and tests.

> **Fork notice:** This is a direct fork of [desktop/desktop](https://github.com/desktop/desktop). Linux support and the README below come from [Brendan Forster (@shiftkey)](https://github.com/shiftkey/desktop) and its contributors; see [credits](CREDITS.md). The original README follows unchanged. Its badge, package feeds and release links point to Shiftkey/community builds. See [this fork’s Linux build guide](docs/contributing/linux-builds.md) for our packages and tests.
